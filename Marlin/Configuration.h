...
#define CUSTOM_MACHINE_NAME "BOB ROSS"
...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 150.5 // mm
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 22.5   // Y offset: -front +behind [the nozzle]
...
#define MANUAL_Z_HOME_POS 258.7 // Distance between the nozzle to printbed after homing
